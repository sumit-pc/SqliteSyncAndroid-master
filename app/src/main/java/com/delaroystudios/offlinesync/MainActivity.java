	...
	public void syncSQLiteMySQLDB(){
		...
		if(userList.size()!=0){
			if(controller.dbSyncCount() != 0){
				...
				Log.i("Response From Server", controller.composeJSONfromSQLite());
				client.post("http://192.168.13.101:56455/sqlitemysqlsync/insertuser.php",params ,new AsyncHttpResponseHandler() {
					@Override
